...
class FullyShardedDataParallel(nn.Module):
    ...
    def __init__(
        ...
        **kwargs: Dict[str, Any],
        ...
        # PJ TODO: Pass in ssd_directory to FlattenParamsWrapper
        self._fsdp_wrapped_module: nn.Module = FlattenParamsWrapper(module, param_list=to_be_flatten_params, ssd_offload=ssd_offload)
    ...
    def _init_param_attributes(self, p: Parameter) -> None:
        ...
        # TODO(anj): We need to condition this on training to avoid extra memory usage.
